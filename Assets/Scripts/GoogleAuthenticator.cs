...
public static class GoogleAuthenticator
{
    ...
    private const int Port = 1234;
        ...
        private static readonly string RedirectUri = "h?";
    #else 
        private const string ClientId = "?"; //TODO: Change [CLIENT_ID] to your CLIENT_ID
        private const string ClientSecret = "?"; //TODO: Change [CLIENT_SECRET] to your CLIENT_SECRET
